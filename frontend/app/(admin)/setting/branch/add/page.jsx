...
export default function UserAddPage() {
  ...
  const title = "Branch Add"; //pathname ? pathname.replace("/", "").charAt(0).toUpperCase() + pathname.slice(2) : "";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE}/branch/create`,
        {
          method: "POST",
          headers: {
  ...
  if (!permissions.includes("create branch")) {
