...
export default function UserPage() {
  ...
  const fetchUsers = async (
    ...
    try {
      const url = `${process.env.NEXT_PUBLIC_API_BASE}/bank/index?page=${page}&pageSize=${pageSize}&searchQuery=${searchQuery}&selectedFilter=${selectedFilter}`;
              ...
              <div className="card-title w-100">
                <div className="row g-2 align-items-center">
                  ...
                  <div className="col-6 col-md-3 col-lg-1 ms-auto">
                    {perms.includes("create bank") ? (
                      <button
                        className="btn btn-primary w-100"
                        onClick={() => router.push(`/setting/bank/add`)}
                      >
                        Add New
                      </button>
                    ) : null}{" "}
